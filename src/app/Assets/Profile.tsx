...
export default function ProfileToUse() {

    return (
        <>

            <svg width="fit-content" height="fit-content" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_15_82)">
                    <rect width="24" height="24" fill="white" className="hover:fill-white"/>
                    <g filter="url(#filater0_d_15_82)">
